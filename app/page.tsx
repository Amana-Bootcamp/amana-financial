...
const DashboardPage = ({ summary, holdings, setPage }) => {
    ...
    const portfolioHistoryData = months.map((month: string) => {
  ...
  return (
    <div>
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-8">
        <h3 className="text-lg font-semibold mb-2">Portfolio Value Over 2024</h3>
...
const StockDetailPage = ({ stock, setPage }) => {
  ...
  return (
    <div>
      <button onClick={() => setPage({ view: 'portfolio' })} className="mb-4 text-sm text-blue-600 hover:underline">&larr; Back to Portfolio</button>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h3 className="text-xl font-semibold mb-4">2024 Price History ({stock.currency})</h3>
  ...
  const renderContent = () => {
    switch (page.view) {
      case 'dashboard':
        ...
        return <DashboardPage summary={portfolioData.portfolio_summary} holdings={filteredHoldings} setPage={setPage} />;
      case 'portfolio':
